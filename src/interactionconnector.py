...
def expandnodes(_logger, _converter, _nodes, _edges, _stringdb, _padb, _tissue, iter):
	...
	lsnodes = list(_nodes)
	tempnodes = set()
	tempnodes.update(list(_converter.mass_convert(_logger, lsnodes, "ACC", "STRING_ID").values()))
	...
	convertion_table = _converter.mass_convert(_logger, list(newnodes), "STRING_ID", "ACC")
